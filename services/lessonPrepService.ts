...
import { appLessonPrepWorker } from './appLessonPrepWorker';
...
export class LessonPrepService {
  ...
  /**
   * Delegate prep execution directly to in-app background worker.
   */
  public async startPrep(params: StartPrepParams): Promise<void> {
    return appLessonPrepWorker.startPrep(params);
  }
