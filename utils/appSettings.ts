...
export const DEFAULT_USAGE_SETTINGS = {
  tiers: {
    free: {
      ...
      display_name: 'Free',
      description:
        'Unlimited Avelut AI chat. Study tools heavily limited: 3 flashcard sets/day, 1 quiz/day, 1 camera scan/day. One 15-min live voice tutorial per month.',
      price_ngn: 0,
    ...
    basic: {
      ...
      display_name: 'Basic',
      description:
        'Unlimited study chats, scans, flashcards & quizzes. 15-min live voice tutorial 1×/day. Longer lessons available via credits.',
      price_ngn: 1500,
      ...
      live_tutorial_included_minutes: 15,
      live_tutorial_minutes_label: '1 × 15-min / day',
      chat_daily_limit: -1,
    ...
    premium: {
      ...
      description:
        'Complete academic mastery: priority AI tutor processing, 2,500 credits, unlimited study tools, and official VIP verification badge.',
      price_ngn: 4000,
    ...
    get weekly() { return this.basic; },
    get monthly() { return this.premium; },
    get pro() { return this.premium; },
    get semester() { return this.premium; },
  },
  feature_costs: {
