...
export const DEFAULT_USAGE_SETTINGS = {
  tiers: {
    ...
    weekly: {
      ...
      live_tutorial_weekly_topics: -1,
      live_tutorial_included_minutes: 105,
      live_tutorial_minutes_pool: 105,
      live_tutorial_minutes_label: '105 live mins / week included',
      chat_daily_limit: -1,
    ...
    basic: {
      ...
      display_name: 'Weekly',
      description:
        '7-day boost: unlimited study tools. 105 live mins included for the week.',
      price_ngn: 1499,
      credit_allocation: 400,
      max_saved_courses: -1,
      live_tutorial_daily_topics: -1,
