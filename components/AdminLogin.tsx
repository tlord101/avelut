                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-200 focus-visible:ring-2 focus-visible:ring-lime-500 rounded focus:outline-none"
