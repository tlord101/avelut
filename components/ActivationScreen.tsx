          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            >
              <div>
                ...
                <ul className="text-[11px] text-slate-700 mt-4 space-y-2 font-semibold">
                  <li className="flex items-center gap-1.5 text-slate-600">✓ {plans.free.limits.courses} Courses roadmap</li>
                  <li className="flex items-center gap-1.5 text-slate-600">✓ {plans.free.limits.ai_requests_per_course} AI queries/course (2h reset)</li>
                  <li className="flex items-center gap-1.5 text-slate-600">✓ {plans.free.limits.exams} Exams limit</li>
                  <li className="flex items-center gap-1.5 text-slate-600">✓ {plans.free.limits.visual_messages} AI assistance chat messages</li>
                </ul>
              </div>
            ...
            >
              <div>
                ...
                <ul className="text-[11px] text-slate-700 mt-4 space-y-2 font-semibold">
                  <li className="flex items-center gap-1.5 text-slate-600">✓ {plans.basic.limits.courses} Courses roadmap</li>
                  <li className="flex items-center gap-1.5 text-slate-600">✓ {plans.basic.limits.ai_requests_per_course} AI queries/course (2h reset)</li>
                  <li className="flex items-center gap-1.5 text-slate-600">✓ {plans.basic.limits.exams} Practice exams</li>
                  <li className="flex items-center gap-1.5 text-slate-600">✓ {plans.basic.limits.visual_messages} Solver messages</li>
            ...
            >
              <div>
                ...
                <ul className="text-[11px] text-slate-700 mt-4 space-y-2 font-semibold">
                  <li className="flex items-center gap-1.5 text-slate-600">✓ {plans.pro.limits.courses} Courses roadmap</li>
                  <li className="flex items-center gap-1.5 text-slate-600">✓ {plans.pro.limits.ai_requests_per_course} AI queries/course (2h reset)</li>
                  <li className="flex items-center gap-1.5 text-slate-600">✓ {plans.pro.limits.exams} Practice exams</li>
                  <li className="flex items-center gap-1.5 text-slate-600">✓ {plans.pro.limits.visual_messages} Solver messages</li>
